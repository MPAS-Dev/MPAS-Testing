...
SPACINGS="40000 20000 10000 5000"
VERTLEVS="34"
RIDGESIZES="2000"
...
do
	...
	echo "   Building Basin"
	echo "   Bulding basin for ${RIDGESIZE} ridgesize"
	...
	cat basin_src/define_kmt.F | sed "s/*RIDGE/${RIDGESIZE}/g" > define_kmt.F
...
#			VISC_H=`echo ${REF_VISC_H}`
			...
			cat MPAS-namelist.input.template  \
				...
				| sed "s/config_h_tracer_eddy_diff4 .*/config_h_tracer_eddy_diff4 = 0.0/g" \
